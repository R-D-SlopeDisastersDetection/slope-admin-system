...
const newSlope = () => {
  currentSlope.value.slope_id = Date.now();
  // 这里写死了后续要改
  currentSlope.value.section_id = sections.value[0].section_id;

  ElMessage.success("新增成功");
  sections.value[0].slopes.push({
    ...currentSlope.value,
